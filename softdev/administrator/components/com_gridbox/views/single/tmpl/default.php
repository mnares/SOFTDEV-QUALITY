...
$url .= $this->single->id.'&name='.urlencode($user->username).'&category=&tmpl=component&id=';
?>
...
<form autocomplete="off" action="<?php echo JRoute::_('index.php?option=com_gridbox&view=single&id='.$this->single->id); ?>"
    ...
    <div id="create-new-app-modal" class="ba-modal-sm modal hide" style="display:none">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" name="ba_view" value="single&id=<?php echo $this->single->id; ?>">
        </div>
        <div class="modal-footer">
                ...
                <div class="ba-main-view">
                    ...
                    <div class="span3">
                        <div class="blog-header">
                            <span class="blog-title"><?php echo $this->single->title; ?></span>
                            <span class="blog-icons">
                                <span>
                                    <i class="zmdi zmdi-settings single-settings"></i>
