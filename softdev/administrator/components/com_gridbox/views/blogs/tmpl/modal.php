...
$url = 'index.php?option=com_gridbox&view=blogs&layout=modal&tmpl=component';
?> 
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        for (var i = 0; i < items.length; i++) {
            items[i].addEventListener('click', function(event){
                ...
                window.parent.document.querySelector('#jform_request_id_name').value = "<?php echo JText::_('ROOT'); ?>";
