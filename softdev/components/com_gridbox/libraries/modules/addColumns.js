...
app.addColumns = function(count){
    ...
    $g.ajax({
        ...
        complete: function(msg){
            ...
            if (target.hasClass('ba-section-items') && (wrapper.hasClass('tabs-content-wrapper')
                    || wrapper.hasClass('ba-overlay-section') || wrapper.hasClass('ba-lightbox'))) {
                flag = false;
            }
            if (target.closest('.megamenu-item').length > 0) {
                flag = true;
            }
