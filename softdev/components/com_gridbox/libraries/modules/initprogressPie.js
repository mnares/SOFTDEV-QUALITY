...
function drawPieLine(deegres, canvas, context, $this)
{
    ...
    context.beginPath();
    context.arc(posX, posY, posX - line / 2, (Math.PI / 180) * 270, (Math.PI / 180) * (270 + 360));
    context.strokeStyle = app.getCorrectColor(obj.background);
    context.lineWidth = line;
    context.stroke();
    context.beginPath();
    context.strokeStyle = app.getCorrectColor(obj.bar);
    context.lineWidth = line;
    context.arc(posX, posY, posX - line / 2, (Math.PI / 180) * 270, (Math.PI / 180) * (270 + deegres));
    context.stroke();
}
