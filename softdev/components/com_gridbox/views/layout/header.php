...
$obj->items->{'item-179497138805'} = gridboxHelper::getOptions('menu');
$obj->items->{'item-179497138805'}->integration = $data;
?>
    <div class="ba-menu-wrapper ba-hamburger-menu ba-collapse-submenu">
        <div class="main-menu">
            ...
            <div class="integration-wrapper">[main_menu=<?php echo $data; ?>]</div>
        </div>
        <div class="open-menu">
