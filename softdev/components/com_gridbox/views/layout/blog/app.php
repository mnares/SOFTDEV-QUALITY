    ...
    <div class="ba-row row-fluid row-with-intro-items" id="item-15002848261">
        ...
        <div class="column-wrapper">
            <div class="span8 ba-grid-column-wrapper" data-span="8">
                <div class="ba-grid-column column-content-align-middle" id="item-15002848262">
                    <div class="ba-overlay"></div>
                    <div class="ba-edit-item">
                        <div class="ba-buttons-wrapper">
                            <span class="ba-edit-wrapper">
            ...
            <div class="span4 ba-grid-column-wrapper" data-span="4">
                <div class="ba-grid-column column-content-align-middle" id="item-15002848263">
                    <div class="ba-overlay"></div>
                    <div class="ba-edit-item">
                        <div class="ba-buttons-wrapper">
                            <span class="ba-edit-wrapper">
