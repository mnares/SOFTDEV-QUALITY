...
<link rel="stylesheet" href="components/com_gridbox/assets/css/ba-style.css?<?php echo $this->about->version; ?>" type="text/css"/>
        ...
        <div class ="row-fluid">
            <div class="row-fluid ba-media-header">
                ...
                <?php 
                    ...
                    ?>
                    <a class="folder-list" data-href="folder=<?php echo $this->_breadcrumb->path[$i]; ?>&tmpl=component">
...
?>
        ...
        <div class="ba-context-menu files-context-menu" style="display: none">
            ...
            <span class="edit-image"><i class="zmdi zmdi-wrench"></i><?php echo JText::_('EDIT'); ?></span>
