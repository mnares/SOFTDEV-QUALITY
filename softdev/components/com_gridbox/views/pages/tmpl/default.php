...
$limit = 20;
$start = 0;
if (isset($_COOKIE["pages_search"])) {
    $search = $_COOKIE["pages_search"];
}
if (isset($_COOKIE["pages_status"])) {
    $status = $_COOKIE["pages_status"];
}
if (isset($_COOKIE["pages_ordering"])) {
    $ordering = $_COOKIE["pages_ordering"];
}
if (isset($_COOKIE["pages_direction"])) {
    $direction = $_COOKIE["pages_direction"];
}
if (isset($_COOKIE["pages_limit"])) {
    $limit = $_COOKIE["pages_limit"] * 1;
}
if (isset($_COOKIE["pages_start"])) {
    $start = $_COOKIE["pages_start"] * 1;
}
if ($status == '') {
                    ...
                    <div id="filter-bar">
                        ...
                        <div class="pagination-limit">
                            <div class="ba-custom-select">
                                <input readonly onfocus="this.blur()" value="<?php echo $pagesLimit[$limit]; ?>"
                                    size="<?php echo strlen($pagesLimit[$limit]); ?>" type="text">
