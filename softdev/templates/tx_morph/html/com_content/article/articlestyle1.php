...
<article class="article_style_1 item item-page<?php echo $this->pageclass_sfx . ($this->item->featured) ? ' item-featured' : ''; ?>" itemscope itemtype="http://schema.org/Article">
...
?>
	...
	<div class="post-hero qx-section--stretch">
		<div class="post-hero__bg" style="background: url('<?php echo JUri::root() . '/' . $images->image_fulltext?>') no-repeat 0 0; background-size:cover; background-position: center; min-height: 600px;">
